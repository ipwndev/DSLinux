...
int port;
{
 int s;
    ...
    if (x < 0) {
       say("\e[1;34mERROR:\e[1;37m socket() failed\e[1;00m\n");
       exit(0);
    }
...
fprintf(stderr,"\e[1;34mUsage:\e[1;37m %s \e[1;37m<\e[1;34mhost\e[1;37m> \e[1;37m<\e[1;34mhighest port\e[1;37m>\n\e[1;00m",argv[0]);
      exit(0);}

   if (sscanf(argv[1],"%d.%d.%d.%d",&a,&b,&c,&d) != 4) {
      nuk = gethostbyname(argv[1]);
      if (nuk == NULL) {
         fprintf(stderr,"\e[1;34mERROR:\e[1;37m cannot resolve host \e[1;34m%s\n\e[1;00m",argv[1]);
         exit(0);
      }
   ...
   fprintf(stdout,"\e[1;34mScanning %s - \e[1;36mPorts \e[1;31m1 \e[1;36mthrough \e[1;31m%d\n",rhost,f);
   ...
   for (e=1;e<=f;e++) {
	...
	say("\e[1;37m[\e[1;31m%d\e[1;37m]\e[1;37m (\e[1;34m%s\e[1;37m)\e[1;34m is running.\e[1;00m\n",e,(tec == NULL) ? "UNKNOWN" : tec->s_name);  }
   }
}
