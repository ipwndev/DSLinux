...
struct expr *
expr_alloc_one(enum expr_type type, struct expr *ce)
{
    struct expr *e = malloc(sizeof(*e));
    memset(e, 0, sizeof(*e));
    e->type = type;
...
struct expr *
expr_alloc_two(enum expr_type type, struct expr *e1, struct expr *e2)
{
    struct expr *e = malloc(sizeof(*e));
    memset(e, 0, sizeof(*e));
    e->type = type;
...
struct expr *
expr_alloc_comp(enum expr_type type, struct symbol *s1, struct symbol *s2)
{
    struct expr *e = malloc(sizeof(*e));
    memset(e, 0, sizeof(*e));
    e->type = type;
...
struct expr *
expr_alloc_and(struct expr *e1, struct expr *e2)
{
    if (!e1)
	return e2;
...
static void
__expr_eliminate_eq(enum expr_type type, struct expr **ep1, struct expr **ep2)
{
    if (e1->type == type) {
...
void
expr_eliminate_eq(struct expr **ep1, struct expr **ep2)
{
...
struct expr *
expr_eliminate_yn(struct expr *e)
{
    struct expr *tmp;
...
struct expr *
expr_join_and(struct expr *e1, struct expr *e2)
{
    struct expr *tmp;
    struct symbol *sym1, *sym2;
...
struct expr *
expr_eliminate_dups(struct expr *e)
{
    int oldcount;
    if (!e)
	return e;
...
int
expr_contains_symbol(struct expr *dep, struct symbol *sym)
{
    if (!dep)
	return 0;
...
bool
expr_depends_symbol(struct expr * dep, struct symbol * sym)
{
    if (!dep)
	return false;
...
struct expr *
expr_extract_eq_and(struct expr **ep1, struct expr **ep2)
{
...
struct expr *
expr_extract_eq_or(struct expr **ep1, struct expr **ep2)
{
    struct expr *tmp = NULL;
...
void
expr_extract_eq(enum expr_type type, struct expr **ep, struct expr **ep1,
		struct expr **ep2)
{
#define e1 (*ep1)
#define e2 (*ep2)
...
int
expr_compare_type(enum expr_type t1, enum expr_type t2)
{
#if 0
    return 1;
#else
...
void
expr_print(struct expr *e, void (*fn) (void *, const char *), void *data,
	   int prevtoken)
{
    if (!e) {
	fn(data, "y");
