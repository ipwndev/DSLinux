...
/*
**
** This method expands the specified URL by locating any special
** characters and converting them to a three-character notation.
** For example, the character '=' would be represented as '%3e'.
**
*/
...
/*
**
** The following function will convert the specified character into a
** numeric hex representation in the range 0-15.
**
*/
...
** notions and coverting them to a special character. For example,
** the notation '%3e' would be converted to '='.
**
*/
...
/*
**
** This method is supposed to free up all memory used by the QStrings.
** In reality it does nothing, as the detach() method in QString is empty.
**
*/
void
KURL::detach()
...
/*
**
** This method is an overloaded object creator. It sets all "parts"
** to empty, and marks itself as malformed.
**
*/
KURL::KURL() 
{ 
...
/*
**
** This method is an overloaded object creator.
** This is where all the grief is.
**
*/
KURL::KURL( KURL & _base_url, const char * _rel_url )
{
  ...
  if(relURL.find(QRegExp("^[a-zA-Z][a-zA-Z0-9\\+\\.\\-]*://")) == 0 ||
     relURL.find("man", 0, false) == 0 ||
     (relURL.find(QRegExp("^[a-zA-Z][a-zA-Z0-9\\+\\.\\-]*:/?[a-zA-Z0-9%_!~'();:@&=$,\\?\\*\\+\\.\\-]")) == 0 && !same_protocol ))
  {
    parse( _rel_url );
  }
  ...
  // Relative URL - starts with a "net_path" (RFC 2396).
    ...
    parse( (QString)(_base_url.protocol_part + ":" + _rel_url) );
    
  // davet
  else if(relURL.find("./") == 0)
  {
    // added by jsk .. the below changed by adding in the path_part which
    // is needed to combine a base url with a relative url
    parse((QString)(_base_url.protocol_part + "://" + _base_url.host_part + _base_url.path_part + "/" + (_rel_url + 2)));
  }

  else if((_rel_url[0] == '/') && (_rel_url[1] != '/'))
  {
    parse((QString)(_base_url.protocol_part + "://" + _base_url.host_part + _rel_url));
  }

  else
  {
    parse((QString)(_base_url.protocol_part + "://" + _base_url.host_part + _base_url.path_part + _rel_url));
...
/*
**
** This method is an overloaded object creator. It will parse the
** specified URL, split it into its "parts", and check to see if
** it is malformed.
**
*/
...
/*
**
** This method will parse the specified URL. It splits out and recovers
** the following URL components or "parts":
**
**   o protocol_part:     "http"
**   o host_part:         "www.censoft.com"
**   o path_part:         "/dir1/dir2/element.html" (contains %xy notation)
**   o path_part_decoded: "/dir1/dir2/element.html" (contains XY characters)
**   o search_part:       "MT=harry&SM=MC&DV=0"     (all characters after ?)
**   o ref_part:          "LABEL1"                  (all characters after #)
**   o dir_part:          "/dir1/dir2/"
**   o user_part:         ?
**   o passwd_part:       ?
**   o port_number:       80
**   o bNoPath:           bool                      (indicates empty path)
**   o malformed:         bool                      (indicates bogus URL)
**
*/
...
/*
**
** This method is an overloaded object creator. It sets the specified
** protocol, host, path, and refernce parts. No checking is done - the
** parts specified must be correct.
**
*/
...
/*
**
** This method will return a pointer to the host string, or NULL if
...
/*
**
** This method is the object's destructor.
**
*/
KURL::~KURL()
{
...
/*
**
** This method will return the path of the URL or NULL if there is none.
** Any special characters are expanded to their '%xy' notation.
**
*/
...
/*
**
** This method will return the path of the URL or NULL is there is none.
** Any special characters are left as-is.
**
*/
...
/*
**
** This method will return the search part of the URL or NULL
** if there is none.
**
*/
...
/*
**
** This method will return the protocol part of the URL or NULL
** if there is none.
**
*/
...
/*
**
** This method will set the specified protocol part.
** No checking is done - the protocol must be correct.
**
*/
...
/*
**
** This method will set the specified search part.
** No checking is done - the search must be correct.
**
*/
...
/*
**
** This method will return the reference part of the URL or NULL
** if there is none.
**
*/
...
/*
**
** This method will return the user part of the URL or NULL
** if there is none.
**
*/
...
/*
**
** This method will return the port number of the URL. If no
** port has been specified, '0' is returned.
**
*/
...
/*
**
** This method will return the password part of the URL or NULL
** if there is none.
**
*/
...
/*
**
** This method will set the specified path.
** No checking is done - the path must be correct.
**
*/
...
{
  // if NULL passed as directory, just exit
  if ( !_dir )
    return false;
    
  // clear the decoded path
  path_part_decoded = 0;

  // set the initial bNoPath value
  bNoPath = ( _dir[0] == 0);

  // if URL starts with "/file:~", build path with user's HOME directory
  ...
  // path_part must contain a webpath
  else
  {
...
void KURL::cleanPath()
{
  ...
  // commented out .. jsk .. QDir is unimplemented  .. please fix
