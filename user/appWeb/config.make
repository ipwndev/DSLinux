...
#
BLD_AR				:= m68k-elf-ar
BLD_CC				:= ucfront-gcc m68k-elf-gcc -m5200 -DCONFIG_COLDFIRE
BLD_CC_FOR_BUILD 	:= cc
BLD_JAVAC			:= javac
BLD_LD				:= m68k-elf-ld
BLD_LD_FOR_BUILD	:= ld
BLD_RANLIB			:= m68k-elf-ranlib

#
#	Standard build flags
#
BLD_CFLAGS			:= -Os -g -fomit-frame-pointer -fno-common -fno-builtin -Wall   -DEMBED -msep-data -Dlinux -D__linux__ -Dunix -D__uClinux__
BLD_IFLAGS			:= 
BLD_LDFLAGS			:= -Wl,-elf2flt -Wl,-move-rodata
