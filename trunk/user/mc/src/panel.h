...
//    double   total;		/* Bytes in marked files */
    unsigned long long   total;		/* Bytes in marked files */ // Fix by Hatred
    ...
    int      exe_first;    	/* Listing is exe sensitive? */
...
#ifdef HAVE_CHARSETS
    int	     panel_charset;  	/* panel_charset for displaying lists */
