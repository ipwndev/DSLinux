...
#define AcquireCacheViewThreadSet  PrependMagickMethod(AcquireCacheViewThreadSet)
...
#define DestroyCacheViewSet  PrependMagickMethod(DestroyCacheViewSet)
...
#define GetPixelCacheExtent  PrependMagickMethod(GetPixelCacheExtent)
