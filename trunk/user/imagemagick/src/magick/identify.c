  ...
  if (ping == MagickFalse)
    {
      ...
      if (image->matte != MagickFalse)
        (void) fprintf(file,IdentifyFormat,"alpha",(Quantum)
          ...
          channel_statistics[AlphaChannel].minima/(double) QuantumRange,
          (Quantum) (channel_statistics[AlphaChannel].maxima/scale),(double)
          channel_statistics[AlphaChannel].maxima/(double) QuantumRange,
          channel_statistics[AlphaChannel].mean/(double) scale,
          channel_statistics[AlphaChannel].mean/(double) QuantumRange,
