...
//*** cheats
case SDLK_MINUS: cheat= TRUE; dock_player();
break;
case SDLK_EQUALS: cheat= TRUE; detonate_bomb = 1;
break;
...
case SDLK_BACKQUOTE: cheat= TRUE; 
	cmdr.fuel=350;
	energy= 250;
	front_shield= 220;
	aft_shield= 240;
...
break;
case SDLK_SEMICOLON: kbd_inc_speed_pressed = TRUE; 
break;
case SDLK_SLASH: kbd_dec_speed_pressed = TRUE; 
break;
...
break;
case SDLK_LEFT:
case SDLK_COMMA: kbd_left_pressed = TRUE; 
break;
case SDLK_RIGHT:
case SDLK_PERIOD: kbd_right_pressed = TRUE; 
break;
case SDLK_SPACE: 
...
case SDLK_a: kbd_fire_pressed = FALSE; 
break;
case SDLK_SEMICOLON: kbd_inc_speed_pressed = FALSE; 
break;
case SDLK_SLASH: kbd_dec_speed_pressed = FALSE; 
break;

case SDLK_UP:
case SDLK_s: kbd_up_pressed = FALSE; 
break;
case SDLK_DOWN:
case SDLK_x: kbd_down_pressed = FALSE; 
break;
case SDLK_LEFT:
case SDLK_COMMA: kbd_left_pressed = FALSE; 
break;
case SDLK_RIGHT:
case SDLK_PERIOD: kbd_right_pressed = FALSE; 
break;

case SDLK_t: 
case SDLK_k: kbd_target_missile_pressed = FALSE; 
break;

case SDLK_SPACE: kbd_space_pressed = FALSE; 
kbd_inc_speed_pressed = FALSE;
break;
case SDLK_j: kbd_jump_pressed = FALSE; 
break;
case SDLK_e: kbd_ecm_pressed = FALSE; 
break;

case SDLK_o: kbd_origin_pressed= FALSE; 
break;


case SDLK_1: kbd_F1_pressed = FALSE; 
break;
case SDLK_2: kbd_F2_pressed = FALSE; 
break;
case SDLK_3: kbd_F3_pressed = FALSE; 
break;
case SDLK_4: kbd_F4_pressed = FALSE; 
break;
case SDLK_5: kbd_F5_pressed = FALSE; 
break;
case SDLK_6: kbd_F6_pressed = FALSE; 
break;
case SDLK_7: kbd_F7_pressed = FALSE; 
break;
case SDLK_8: kbd_F8_pressed = FALSE; 
break;
case SDLK_9: kbd_F9_pressed = FALSE; 
break;
case SDLK_0: kbd_F10_pressed = FALSE; 
break;
...
int main(int argc, char **argv) {
    ...
    screen=SDL_SetVideoMode( winSizeX, winSizeY, 16, SDL_SWSURFACE );

    // initialize TinyGL:
    unsigned int pitch = screen->pitch;
    int	mode = ZB_MODE_5R6G5B;
...
glColor3f(1, 1, 1);
    ...
    while(isRunning) {
       ...
       switch(evt.type) 
       {
	        ...
	        case SDL_KEYUP:
			keyRelease(evt.key.keysym.sym);
        	break;
        }

	//*** GAME SPEED control & lock FPS
	while( (tPause-tNow) < 50)  //was timerINTERVAL=50 in GLUT version, comment this line or set lowert number to speedup the game
	    tPause = SDL_GetTicks();
...
//*** DRAW *******************************************************************************
	...
	// show frames per second    
        if(frames > 10)
    	{
    	    sprintf(fpsCounterString, "FPS %.1f/20", (float)1000/(tNow-tLastFps));
	    frames = 0;
	}
        glColor3f(0, 0.5, 0.7);
	txtOut (1, 1, fpsCounterString, 3);
